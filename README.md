## :gun: Python Shooting Game을 구현을 통한 Git 협업 익히기 프로젝트 :collision:

![image](https://user-images.githubusercontent.com/84713532/216852722-e6a1f98f-8b4c-46ba-bf57-3ea3b2285eb0.png)

## :page_with_curl: 개요

Git 사용법을 익히는 것을 주목적으로 한 python 기반의 슈팅 게임을 구현하는 프로젝트입니다.

- VScode와 Github desktop 활용
- branch를 사용하여 PR 요청하기
- branch collision 대처

[슈팅 게임 출처](https://www.youtube.com/watch?v=-e_5sOsKqrU&t=1s)

---

## :floppy_disk: Mini Project (2023/02/01 ~ 2023/02/09) :date:
...
## :notebook_with_decorative_cover: 더 구현하고 싶었던 기능

- 게임의 테마를 바꿔보기 (시장에서 방해되는 동물들 과일로 물리치기 게임)
- 비행기나 운석의 속도 초기 위치 등 변경
- 필살기 도입


<h4> 예) New Game : 과일가게 지키기 <h4>
